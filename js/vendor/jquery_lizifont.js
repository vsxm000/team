...
var arr = ['', '陈宁宁', '马明星', '孙晓敏', '赵欣欣', '许世丛', '蒋妙秀', '冯贺齐', '孙丽娟', ' ', '  '];
// 再次调用可以实现改变
var index = 0;
var MESSAGE = arr[0];
// 给右按钮绑定点击事件
...
var canvas = document.getElementById('spring-text');
var titleDesktop = document.getElementById('title-desktop');

if(canvas){
  body.removeChild(canvas);
  canvas = document.createElement('canvas')
  canvas.setAttribute('id','spring-text');
  console.log(canvas)
  body.insertBefore(canvas,titleDesktop)
}
...
// var title = document.querySelector('#title-desktop');
// divs.onclick = function () {
//   title.innerText = 'jisadnasd';
//   lizifont();
// }